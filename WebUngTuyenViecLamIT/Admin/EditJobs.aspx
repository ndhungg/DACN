<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="EditJobs.aspx.cs" Inherits="WebUngTuyenViecLamIT.Admin.EditJobs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="background-image: url('../Images/bg.jpg'); width: 100%; height: 720px; background-repeat: no-repeat; background-size: cover; background-attachment: fixed;">
        <div class="container pt-4 pb-4">
            ...
            <div class="row mr-lg-5 ml-lg-5 mb-3">
                <div class="col-md-6 pt-3">
                    <label for="ddbStatus" style="font-weight: 600">Trạng Thái</label>
                    <asp:DropDownList ID="ddbStatus" runat="server" CssClass="form-control">
                        <asp:ListItem Value="0">Trạng Thái</asp:ListItem>
                        <asp:ListItem>Chưa tải lên</asp:ListItem>
                        <asp:ListItem>Đã tải lên</asp:ListItem>
                    </asp:DropDownList>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Bạn chưa chọn trạng thái !!!" ForeColor="Red"
                        ControlToValidate="ddbStatus" Display="Dynamic" SetFocusOnError="true" Font-Size="Small" InitialValue="0"></asp:RequiredFieldValidator>
                </div>
            </div>
