             ...
             <div class="col-md-12">
                 <asp:GridView ID="GridView1" runat="server" CssClass="table tab-hover table-bordered" HeaderStyle-HorizontalAlign="Center"
                     ...
                     <Columns>
                         ...
                         <asp:BoundField DataField="NoPost" HeaderText="Số Lượng">
                         <ItemStyle HorizontalAlign="Center" />
                         </asp:BoundField>

                         <asp:BoundField DataField="Qualification" HeaderText="Trường Học">
                         <ItemStyle HorizontalAlign="Center" />
                         </asp:BoundField>
                         ...
                         <ItemStyle HorizontalAlign="Center" />
                          ...
                          <asp:BoundField DataField="LastDateToApply" HeaderText="Thời Gian Ứng Tuyển" DataFormatString="{0: dd MMMM yyyy}">
                         <ItemStyle HorizontalAlign="Center" />
                         </asp:BoundField>
