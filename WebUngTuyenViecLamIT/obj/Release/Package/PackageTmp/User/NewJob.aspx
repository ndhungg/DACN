<%@ Page Title="" Language="C#" MasterPageFile="~/User/Company/CompanyMaster.Master" AutoEventWireup="true" CodeBehind="NewJob.aspx.cs" Inherits="WebUngTuyenViecLamIT.User.NewJob" %>
     ...
     <div style="background-image: url('../Images/bg.jpg'); width: 100%; height: 720px; background-repeat: no-repeat; background-size: cover; background-attachment: fixed;">
        <div class="container pt-4 pb-4">
            <div class="btn-toolbar justify-content-between mb-3">
             ...
             <h3 class="text-center">Thêm Mới Công Việc</h3>
            ...
            <div class="row mr-lg-3 ml-lg-5 mb-3 pt-4">
                <div class="col-md-2 col-md-offset-2 mb-3">
                    <asp:Button ID="btnAdd" runat="server" Text="Thêm Mới" CssClass="btn btn-primary btn-block" OnClick="btnAdd_Click"/>
                </div>
            </div>
